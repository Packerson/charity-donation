...
SECRET_KEY = 'django-insecure-$muf@k)-l5$6atwop8f)h!tdn%*08g)cvbd%_3qgnf#1^!2es@'
...
STATIC_URL = 'charity_app/static/'

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "charity_app/static"),
]
...
try:
    from charity_donations.local_settings import DATABASES
